-- Project Afyon 042 — AFMB Lunapark Fun Pack settlement
-- Adds the three new interactive client-session games to the authoritative wallet settlement whitelist.
