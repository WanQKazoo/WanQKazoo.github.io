-- Project Afyon 050 — Retire AFMB Kasa Kırma
-- Kasa Kırma was fun but too easy to exploit. Keep historical chance_plays rows readable,
-- but reject any new vault_crack settlement at the server boundary.
